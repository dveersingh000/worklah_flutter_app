...
class _CashOutHomeScreenState extends State<CashOutHomeScreen> {
  ...
  Future<void> fetchWalletBalance() async {
    try {
      ...
      setState(() {
        availableBalance = double.tryParse(response['wallet']['balance'].toString()) ?? 0.0;
        isLoading = false;
      });
    } catch (e) {
        ...
        isLoading
            ...
            : Row(
                ...
                children: [
                  ...
                  Text("\$${availableBalance.toStringAsFixed(2)}", style: CustomTextPopins.bold14(AppColors.blackColor)),
                ],
              ),
